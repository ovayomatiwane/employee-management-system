    ...
    public partial class initialmigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConsultantTasks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ConsultantTasks_Consultants_ConsultantId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ConsultantTasks_Tasks_TaskId",
                        column: x => x.TaskId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConsultantTasks_ConsultantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConsultantTasks_TaskId",
                table: "ConsultantTasks",
                column: "TaskId");
        }
